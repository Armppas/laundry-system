...
export default function Button({
  ...
  const variants = {
    primary:
      "bg-primary-500 hover:bg-primary-600 text-white shadow-sm hover:shadow-md active:shadow-sm",
    secondary:
      "bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-900 dark:text-neutral-100",
    danger:
      "bg-danger-500 hover:bg-danger-600 text-white shadow-sm hover:shadow-md active:shadow-sm",
    ghost:
